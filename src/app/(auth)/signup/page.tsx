    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-surface-1">
        <div className="w-full max-w-sm space-y-4 rounded-[16px] border border-line-1 bg-white p-8 text-center shadow-card">
          <svg className="mx-auto" width={24} height={24} viewBox="0 0 32 32" fill="none">
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-surface-1">
      <div className="w-full max-w-sm space-y-6 rounded-[16px] border border-line-1 bg-white p-8 shadow-card">
        ...
        <h1 className="text-center text-[24px] font-semibold tracking-[-0.02em] text-ink-1000">Sign up</h1>
